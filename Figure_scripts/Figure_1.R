###################### This scripts generates figure 1 of the paper titled "SpeSpeNet: An interactive and user-friendly tool 
...
relab <- read.delim("NW_data/Griftpark/fixed.grift.otu.txt", header = T, sep = "\t",row.names = 1)
tax <- read.delim("NW_data/Griftpark/fixed.grift.tax.txt", header = T, sep = "\t",row.names = 1)
...
env.cor <- as.numeric(cor(env[["O2.levels"]],base::t(use_relab), use = "pairwise",method = "pearson"))
...
png(filename = "~/Documents/spe_spe/Custom_figure_manuscript/Grift/net_k2.png",width = 500,height = 500)
plot.clust
dev.off()
...
png(filename = "~/Documents/spe_spe/Custom_figure_manuscript/Grift/net_O2.png",width = 500,height = 500)
plot.env
dev.off()
...
png(filename = "~/Documents/spe_spe/Custom_figure_manuscript/Grift/net_order.png",width = 500,height = 500)
plot.tax
dev.off()
...
png(filename = "~/Documents/spe_spe/Custom_figure_manuscript/Grift/net_stage.png",width = 500,height = 500)
plot.max
dev.off()
...
png(filename = "~/Documents/spe_spe/Custom_figure_manuscript/Grift/barplot_order.png",width = 300,height = 500)
barplot.order
dev.off()
...
png(filename = "~/Documents/spe_spe/Custom_figure_manuscript/Grift/corplot_order.png",width = 300,height = 500)
cor.plot
dev.off()
...
plot.comb <-plot_grid(plot.tax,plot.env,plot.max,plot.clust,bar.cor,align = "none",nrow = 2,
                      labels = c("A","B","C","D",""),label_size = 35,label_colour = "black",label_x = 0.5)

png(filename = "~/Documents/spe_spe/Custom_figure_manuscript/Grift/comb_plot.png",width = 1600,height = 1000)
plot.comb
dev.off()