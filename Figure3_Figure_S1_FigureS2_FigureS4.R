...
s4.ph <- ggraph(tidy.net, layout = 'fr') +
  geom_edge_arc0(
    width = 0.1,
    alpha = 1,
    strength = 0,
...
s4.om <- ggraph(tidy.net, layout = 'fr') +
  geom_edge_arc0(
    width = 0.1,
    alpha = 1,
    strength = 0,
...
s4 <- plot_grid(s4.ph,s4.om,plot.max.st,labels = c("A","B","C"),label_size = 35,label_colour = "black",nrow = 2)

png(filename = "~/Documents/spe_spe/Custom_figure_manuscript/Brenzinger/s4.png",width = 1000,height = 1000)
s4
dev.off()
...
fig.s1 <- plot_grid(plot.clay.nifh,plot.clay.nosZII,labels = c("A","B"),label_size = 35,label_colour = "black")

png(filename = "~/Documents/spe_spe/Custom_figure_manuscript/Brenzinger/fig_s1.png",width = 1000,height = 500)
fig.s1
dev.off()

############################ Poster images ###############################

p1 <- plot_grid(plot.max.amendment,plot.max.st,labels = c("A","B"),label_size = 35,label_colour = "black")

png(filename = "~/Documents/spe_spe/Custom_figure_manuscript/Brenzinger/fig_p1.png",width = 1000,height = 500)
p1
dev.off()

p2 <- plot_grid(plot.max.clay.amendment,plot.tax,labels = c("A","B"),label_size = 35,label_colour = "black")

png(filename = "~/Documents/spe_spe/Custom_figure_manuscript/Brenzinger/fig_p2.png",width = 1000,height = 500)
p2
dev.off()

bar.cor.p <- plot_grid(barplot.phylum,cor.plot,labels = c("B","C"),label_size = 35,label_colour = "black")

p3 <- plot_grid(plot.clust,bar.cor.p,labels = c("A",""),label_size = 35,label_colour = "black")

png(filename = "~/Documents/spe_spe/Custom_figure_manuscript/Brenzinger/fig_p3.png",width = 1000,height = 500)
p3
dev.off()

p4 <- plot_grid(plot.clay.nirk,plot.clay.plant.heights,labels = c("A","B"),label_size = 35,label_colour = "black")

png(filename = "~/Documents/spe_spe/Custom_figure_manuscript/Brenzinger/fig_p4.png",width = 1000,height = 500)
p4
dev.off()

########## Supplemental figure S3, different layouts
...
plot.clay.nosZII.altered <- ggraph(tidy.net, layout = 'fr') +
  geom_edge_arc0(
    width = 0.5,
    alpha = 0.8,
    strength = 0.8,
...
png(filename = "~/Documents/spe_spe/Custom_figure_manuscript/Brenzinger/net_nosZII_altered.png",width = 500,height = 500)
plot.clay.nosZII.altered
dev.off()

fig.s3 <- plot_grid(plot_grid(plot.clay.nosZII.default,labels = c("A"),label_size = 35,label_colour = "white"),
                plot_grid(plot.clay.nosZII.altered,labels = c("B"),label_size = 35,label_colour = "black"))
...
fig.s3.iso <- plot_grid(plot_grid(plot.clay.nosZII.default,labels = c("A"),label_size = 35,label_colour = "white"),
                    plot_grid(plot.clay.nosZII.altered.iso,labels = c("B"),label_size = 35,label_colour = "black"))

png(filename = "~/Documents/spe_spe/Custom_figure_manuscript/Brenzinger/fig_s3_iso.png",width = 1000,height = 500)
fig.s3.iso
dev.off()
